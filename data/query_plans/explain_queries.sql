...
explain using json select /* { "query":"query96","streamId":0,"querySequence":1 } */  count(*)
from store_sales
...
explain using json select /* { "query":"query07","streamId":0,"querySequence":2 } */  i_item_id,
...
explain using json WITH /* { "query":"query75","streamId":0,"querySequence":3 } */ all_sales AS (
 SELECT d_year
       ,i_brand_id
       ,i_class_id
       ,i_category_id
...
explain using json select /* { "query":"query44","streamId":0,"querySequence":4 } */  asceding.rnk, i1.i_product_name best_performing, i2.i_product_name worst_performing
from(select *
...
explain using json with /* { "query":"query39_p1","streamId":0,"querySequence":5 } */ inv as
...
explain using json with /* { "query":"query39_p2","streamId":0,"querySequence":5 } */ inv as
(select w_warehouse_name,w_warehouse_sk,i_item_sk,d_moy
       ,stdev,mean, case mean when 0 then null else stdev/mean end cov
 from(select w_warehouse_name,w_warehouse_sk,i_item_sk,d_moy
            ,stddev_samp(inv_quantity_on_hand) stdev,avg(inv_quantity_on_hand) mean
...
explain using json with /* { "query":"query80","streamId":0,"querySequence":6 } */ ssr as
...
explain using json select /* { "query":"query32","streamId":0,"querySequence":7 } */  sum(cs_ext_discount_amt)  as "excess discount amount"
from
   catalog_sales
   ,item
   ,date_dim
...
explain using json select /* { "query":"query19","streamId":0,"querySequence":8 } */  i_brand_id brand_id, i_brand brand, i_manufact_id, i_manufact,
...
explain using json select /* { "query":"query25","streamId":0,"querySequence":9 } */
 i_item_id
 ,i_item_desc
 ,s_store_id
 ,s_store_name
...
explain using json with /* { "query":"query78","streamId":0,"querySequence":10 } */ ws as
...
explain using json select /* { "query":"query86","streamId":0,"querySequence":11 } */
...
explain using json with /* { "query":"query01","streamId":0,"querySequence":12 } */ customer_total_return as
...
explain using json select /* { "query":"query91","streamId":0,"querySequence":13 } */
...
explain using json select /* { "query":"query21","streamId":0,"querySequence":14 } */  *
...
explain using json select /* { "query":"query43","streamId":0,"querySequence":15 } */  s_store_name, s_store_id,
...
explain using json select /* { "query":"query27","streamId":0,"querySequence":16 } */  i_item_id,
...
explain using json select /* { "query":"query94","streamId":0,"querySequence":17 } */
...
explain using json select /* { "query":"query45","streamId":0,"querySequence":18 } */  ca_zip, ca_state, sum(ws_sales_price)
...
explain using json with /* { "query":"query58","streamId":0,"querySequence":19 } */ ss_items as
...
explain using json with /* { "query":"query64","streamId":0,"querySequence":20 } */ cs_ui as
 (select cs_item_sk
...
explain using json select /* { "query":"query36","streamId":0,"querySequence":21 } */
...
explain using json with /* { "query":"query33","streamId":0,"querySequence":22 } */ ss as (
 select
...
explain using json select /* { "query":"query46","streamId":0,"querySequence":23 } */  c_last_name
       ,c_first_name
       ,ca_city
       ,bought_city
       ,ss_ticket_number
...
explain using json select /* { "query":"query62","streamId":0,"querySequence":24 } */
...
explain using json select /* { "query":"query16","streamId":0,"querySequence":25 } */
...
explain using json select /* { "query":"query10","streamId":0,"querySequence":26 } */
  cd_gender,
  cd_marital_status,
  cd_education_status,
  count(*) cnt1,
...
explain using json select /* { "query":"query63","streamId":0,"querySequence":27 } */  *
...
explain using json select /* { "query":"query69","streamId":0,"querySequence":28 } */
  cd_gender,
  cd_marital_status,
  cd_education_status,
  count(*) cnt1,
...
explain using json with /* { "query":"query60","streamId":0,"querySequence":29 } */ ss as (
 select
...
explain using json with /* { "query":"query59","streamId":0,"querySequence":30 } */ wss as
 (select d_week_seq,
        ss_store_sk,
        sum(case when (d_day_name='Sunday') then ss_sales_price else null end) sun_sales,
        sum(case when (d_day_name='Monday') then ss_sales_price else null end) mon_sales,
...
explain using json select /* { "query":"query37","streamId":0,"querySequence":31 } */  i_item_id
       ,i_item_desc
       ,i_current_price
...
explain using json select /* { "query":"query98","streamId":0,"querySequence":32 } */ i_item_id
      ,i_item_desc
      ,i_category
      ,i_class
      ,i_current_price
...
explain using json select /* { "query":"query85","streamId":0,"querySequence":33 } */  substr(r_reason_desc,1,20)
       ,avg(ws_quantity)
...
explain using json select /* { "query":"query70","streamId":0,"querySequence":34 } */
...
explain using json select /* { "query":"query67","streamId":0,"querySequence":35 } */  *
...
explain using json select /* { "query":"query28","streamId":0,"querySequence":36 } */  *
...
explain using json with /* { "query":"query81","streamId":0,"querySequence":37 } */ customer_total_return as
...
explain using json with /* { "query":"query97","streamId":0,"querySequence":38 } */ ssci as (
...
explain using json select /* { "query":"query66","streamId":0,"querySequence":39 } */
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
 	,w_county
...
explain using json select /* { "query":"query90","streamId":0,"querySequence":40 } */  cast(amc as decimal(15,4))/cast(pmc as decimal(15,4)) am_pm_ratio
...
explain using json with /* { "query":"query47","streamId":0,"querySequence":42 } */ v1 as(
...
explain using json with /* { "query":"query95","streamId":0,"querySequence":43 } */ ws_wh as
...
explain using json select /* { "query":"query92","streamId":0,"querySequence":44 } */
...
explain using json select /* { "query":"query03","streamId":0,"querySequence":45 } */  dt.d_year
...
explain using json WITH /* { "query":"query51","streamId":0,"querySequence":46 } */ web_v1 as (
select
...
explain using json select /* { "query":"query35","streamId":0,"querySequence":47 } */
  ca_state,
  cd_gender,
  cd_marital_status,
  cd_dep_count,
...
explain using json select /* { "query":"query49","streamId":0,"querySequence":48 } */  channel, item, return_ratio, return_rank, currency_rank from
 (select
 'web' as channel
 ,web.item
 ,web.return_ratio
...
explain using json select /* { "query":"query09","streamId":0,"querySequence":49 } */ case when (select count(*)
                  from store_sales
...
explain using json with /* { "query":"query31","streamId":0,"querySequence":50 } */ ss as
...
explain using json with /* { "query":"query11","streamId":0,"querySequence":51 } */ year_total as (
...
explain using json select /* { "query":"query93","streamId":0,"querySequence":52 } */  ss_customer_sk
...
explain using json select /* { "query":"query29","streamId":0,"querySequence":53 } */
     i_item_id
    ,i_item_desc
    ,s_store_id
    ,s_store_name
...
explain using json select /* { "query":"query38","streamId":0,"querySequence":54 } */  count(*) from (
...
explain using json select /* { "query":"query22","streamId":0,"querySequence":55 } */  i_product_name
             ,i_brand
             ,i_class
             ,i_category
...
explain using json select /* { "query":"query89","streamId":0,"querySequence":56 } */  *
from(
...
explain using json select /* { "query":"query15","streamId":0,"querySequence":57 } */  ca_zip
       ,sum(cs_sales_price)
 from catalog_sales
     ,customer
     ,customer_address
...
explain using json select /* { "query":"query06","streamId":0,"querySequence":58 } */  a.ca_state state, count(*) cnt
...
explain using json select /* { "query":"query52","streamId":0,"querySequence":59 } */  dt.d_year
 	,item.i_brand_id brand_id
 	,item.i_brand brand
 	,sum(ss_ext_sales_price) ext_price
 from date_dim dt
...
explain using json select /* { "query":"query50","streamId":0,"querySequence":60 } */
   s_store_name
  ,s_company_id
  ,s_street_number
  ,s_street_name
...
explain using json select /* { "query":"query42","streamId":0,"querySequence":61 } */  dt.d_year
 	,item.i_category_id
 	,item.i_category
...
explain using json select /* { "query":"query41","streamId":0,"querySequence":62 } */  distinct(i_product_name)
 from item i1
...
explain using json select /* { "query":"query08","streamId":0,"querySequence":63 } */  s_store_name
      ,sum(ss_net_profit)
 from store_sales
     ,date_dim
     ,store,
...
explain using json select /* { "query":"query12","streamId":0,"querySequence":64 } */  i_item_id
      ,i_item_desc
      ,i_category
      ,i_class
      ,i_current_price
...
explain using json select /* { "query":"query20","streamId":0,"querySequence":65 } */  i_item_id
       ,i_item_desc
       ,i_category
       ,i_class
       ,i_current_price
...
explain using json select /* { "query":"query88","streamId":0,"querySequence":66 } */  *
from
...
explain using json select /* { "query":"query82","streamId":0,"querySequence":67 } */  i_item_id
       ,i_item_desc
       ,i_current_price
...
explain using json with /* { "query":"query23_p1","streamId":0,"querySequence":68 } */ frequent_ss_items as
...
explain using json with /* { "query":"query23_p2","streamId":0,"querySequence":68 } */ frequent_ss_items as
 (select substr(i_item_desc,1,30) itemdesc,i_item_sk item_sk,d_date solddate,count(*) cnt
  from store_sales
      ,date_dim
      ,item
...
explain using json with /* { "query":"query14_p1","streamId":0,"querySequence":69 } */  cross_items as
...
explain using json select /* { "query":"query65","streamId":0,"querySequence":71 } */
	s_store_name,
	i_item_desc,
	sc.revenue,
	i_current_price,
...
explain using json select /* { "query":"query71","streamId":0,"querySequence":72 } */ i_brand_id brand_id, i_brand brand,t_hour,t_minute,
...
explain using json select /* { "query":"query34","streamId":0,"querySequence":73 } */ c_last_name
       ,c_first_name
       ,c_salutation
       ,c_preferred_cust_flag
       ,ss_ticket_number
...
explain using json select /* { "query":"query48","streamId":0,"querySequence":74 } */ sum (ss_quantity)
...
explain using json with /* { "query":"query30","streamId":0,"querySequence":75 } */ customer_total_return as
...
explain using json with /* { "query":"query74","streamId":0,"querySequence":76 } */ year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
       ,d_year as year
...
explain using json select /* { "query":"query87","streamId":0,"querySequence":77 } */ count(*)
...
explain using json with /* { "query":"query77","streamId":0,"querySequence":78 } */ ss as
 (select s_store_sk,
         sum(ss_ext_sales_price) as sales,
...
explain using json select /* { "query":"query84","streamId":0,"querySequence":80 } */  c_customer_id as customer_id
...
explain using json with /* { "query":"query54","streamId":0,"querySequence":81 } */ my_customers as (
...
explain using json select /* { "query":"query55","streamId":0,"querySequence":82 } */  i_brand_id brand_id, i_brand brand,
 	sum(ss_ext_sales_price) ext_price
...
explain using json with /* { "query":"query56","streamId":0,"querySequence":83 } */ ss as (
...
explain using json with /* { "query":"query02","streamId":0,"querySequence":84 } */ wscs as
 (select sold_date_sk
        ,sales_price
...
explain using json select /* { "query":"query26","streamId":0,"querySequence":85 } */  i_item_id,
...
explain using json select /* { "query":"query40","streamId":0,"querySequence":86 } */
   w_state
  ,i_item_id
...
explain using json select /* { "query":"query72","streamId":0,"querySequence":87 } */  i_item_desc
      ,w_warehouse_name
      ,d1.d_week_seq
...
explain using json select /* { "query":"query53","streamId":0,"querySequence":88 } */  * from
...
explain using json select /* { "query":"query79","streamId":0,"querySequence":89 } */
...
explain using json select /* { "query":"query18","streamId":0,"querySequence":90 } */  i_item_id,
        ca_country,
        ca_state,
        ca_county,
...
explain using json with /* { "query":"query24_p1","streamId":0,"querySequence":92 } */ ssales as
(select c_last_name
      ,c_first_name
      ,s_store_name
      ,ca_state
...
explain using json with /* { "query":"query04","streamId":0,"querySequence":93 } */ year_total as (
 select c_customer_id customer_id
       ,c_first_name customer_first_name
       ,c_last_name customer_last_name
       ,c_preferred_cust_flag customer_preferred_cust_flag
...
explain using json select /* { "query":"query99","streamId":0,"querySequence":94 } */
   substr(w_warehouse_name,1,20)
  ,sm_type
  ,cc_name
...
explain using json with /* { "query":"query83","streamId":0,"querySequence":96 } */ sr_items as
 (select i_item_id item_id,
...
explain using json with /* { "query":"query05","streamId":0,"querySequence":98 } */ ssr as
 (select s_store_id,
...
explain using json select /* { "query":"query76","streamId":0,"querySequence":99 } */  channel, col_name, d_year, d_qoy, i_category, COUNT(*) sales_cnt, SUM(ext_sales_price) sales_amt FROM (
